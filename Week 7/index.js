...
//GET REQUEST
axios.get("https://api.vschool.io/RosanneWallach/todo")
.then(response => {
    ...
    checkbox.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/RosanneWallach/todo/" + event.currentTarget.id, {completed:updates})
    ...
    button.addEventListener("click", (event) => {
        axios.delete("https://api.vschool.io/RosanneWallach/todo/" + event.currentTarget.id)
            .then(response => {response.data
            location.reload()
            })
            .catch(error => console.log(error))
    ...
    submits.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/RosanneWallach/todo/" + event.currentTarget.id, {
            title:t,
            description:d,
            price:p
            })
...
form.addEventListener("submit", function(event){
    ...
    axios.post("https://api.vschool.io/RosanneWallach/todo", newTodo)
        .then(response => {response.data 
        form.reset()
        location.reload()
        })
